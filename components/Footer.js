...
const Footer = () => {
    return (
        <footer className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto flex md:items-center shadow-lg lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                    ...
                    <p className="ml-2 mt-2 text-sm text-gray-500 italic">&lt;Code/&gt; Your Look</p>
                    <p className="ml-2 mt-2 text-sm text-gray-500 italic">Buy Premium Coding T-shirts, Hoodies and Apparals</p>
                </div>
            ...
            <div className="bg-gray-100">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-gray-500 text-sm text-center sm:text-left">© 2025 DevStyle.com</p>
